function [Y,X] = irf_2nd(gx, hx, gxx, hxx, gss, hss, eta, sig, x0, T)
%
%
...
%
%Output:  vectors X (T by nx) and Y (T by ny) containing containing T-period impulse responses for x and y  
%
