function [fx,fxp,fy,fyp,fypyp,fypy,fypxp,fypx,fyyp,fyy,fyxp,fyx,fxpyp,fxpy,fxpxp,fxpx,fxyp,fxy,fxxp,fxx,f] = bcapital_model
...
f5 = - u_mVV  +  de *  e_mV - 0.45 *  u_mV  ;  %+ej * SV     % -x(18) + (1-de)* x(18)  + qqjV * VsV ;
...
%f24 =  -e_mV + (l_hftmV + l_hntmV + l_lftmV  +l_lntmV+l_hftyV + l_hntyV + l_lftyV + l_lntyV)/N_ForceV    ;   
