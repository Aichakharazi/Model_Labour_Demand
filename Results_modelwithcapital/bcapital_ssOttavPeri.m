...
c_hftyVV,c_hntyVV,c_lftyVV,c_lntyVV,c_hftmVV,c_hntmVV,c_lftmVV,c_lntmVV] = bcapital_ss;
...
ssp_elas          =  -0.28  ;               % ottaviano perri
ssp               = (1/(1+ssp_elas)) ;       % 
sigmaparam_elas   = -0.32;                 % 
ssigmaparam       = (1/(sigmaparam_elas +1)); % 
xiparam_elas  = -0.32;                       % 
xiparam =(1/(xiparam_elas+1));               % 
varrho_elas      = -0.05;                     % 
varrho           = 1/(varrho_elas +1);          %  
upsilon_elas     = -0.05;                    % 
upsilon          = 1/(upsilon_elas +1);         % 
varepsilon_elas  = -0.05;                      % 
varepsilon       = 1/(varepsilon_elas +1)  ;    %  
zetaparam_elas   = -0.05;                      % 
zetaparam        = 1/(zetaparam_elas +1)  ;     % 
...
oy_hf_init =   6.1576e-05


oy_hn_init =   1.1528e-04


oy_lf_init =   7.0243e-05


oy_ln_init =   2.0351e-04


om_hf_init =   1.0503e-04


om_hn_init =   3.4052e-04


om_lf_init =   1.4877e-04


om_ln_init =  4.6809e-04
