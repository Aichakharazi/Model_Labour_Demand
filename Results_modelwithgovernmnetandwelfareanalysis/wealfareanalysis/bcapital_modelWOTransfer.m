function [fx,fxp,fy,fyp,fypyp,fypy,fypxp,fypx,fyyp,fyy,fyxp,fyx,fxpyp,fxpy,fxpxp,fxpx,fxyp,fxy,fxxp,fxx,f] = bcapital_modelWOTransfer
...
f60 = -Uy_hf_initV + bbeta *(  log(  (1-Tax)* e_mV * oy_hf_initV/y_piV * l_hftyV + kkV*(1+rsV) - kkVV ) - l_hftyV^(1+eeta) /(1+eeta)  );
f61 = -Uy_hn_initV + bbeta *(  log(  (1-Tax)* e_mV * oy_hn_initV/y_piV * l_hntyV + kkV*(1+rsV) - kkVV ) - l_hntyV^(1+eeta) /(1+eeta)  );
f62 = -Uy_lf_initV + bbeta *(  log(  (1-Tax)* e_mV * oy_lf_initV/y_piV * l_lftyV + kkV*(1+rsV) - kkVV ) - l_lftyV^(1+eeta) /(1+eeta)  ); 
f63 = -Uy_ln_initV +  bbeta *(  log(  (1-Tax)* e_mV * oy_ln_initV/y_piV * l_lntyV + kkV*(1+rsV) - kkVV ) - l_lntyV^(1+eeta) /(1+eeta)  );

f64 = -Um_hf_initV + bbeta *(  log(  (1-Tax)* e_mV * om_hf_initV/y_piV * l_hftmV + kkV*(1+rsV) - kkVV ) - l_hftmV^(1+eeta) /(1+eeta)  );
f65 = -Um_hn_initV + bbeta *(  log(  (1-Tax)* e_mV * om_hn_initV/y_piV * l_hntmV + kkV*(1+rsV) - kkVV ) - l_hntmV^(1+eeta) /(1+eeta)  );
f66 = -Um_lf_initV + bbeta *(  log(  (1-Tax)* e_mV * om_lf_initV/y_piV * l_lftmV + kkV*(1+rsV) - kkVV ) - l_lftmV^(1+eeta) /(1+eeta)  ); 
f67 = -Um_ln_initV + bbeta *(  log(  (1-Tax)* e_mV * om_ln_initV/y_piV * l_lntmV + kkV*(1+rsV) - kkVV ) - l_lntmV^(1+eeta) /(1+eeta)  ); 
