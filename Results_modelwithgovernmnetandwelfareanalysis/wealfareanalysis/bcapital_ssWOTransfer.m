...
Uy_hf_initVV, Uy_hn_initVV, Uy_lf_initVV, Uy_ln_initVV, Um_hf_initVV, Um_hn_initVV, Um_lf_initVV, Um_ln_initVV, k1, deltk1,Tax ] =  bcapital_ssWOTransfer;
...
Uy_hf_initV = bbeta *( log(  (1-Tax)* e_mV * oy_hf_initV/y_piV * l_hftyV + kkV*(1+rsV) - kkVV ) - l_hftyV^(1+eeta) /(1+eeta) )
Uy_hn_initV = bbeta *(  log(  (1-Tax)* e_mV * oy_hn_initV/y_piV * l_hntyV + kkV*(1+rsV) - kkVV ) - l_hntyV^(1+eeta) /(1+eeta)  )
Uy_lf_initV = bbeta *( log(   (1-Tax)* e_mV * oy_lf_initV/y_piV * l_lftyV + kkV*(1+rsV) - kkVV ) - l_lftyV^(1+eeta) /(1+eeta)  ) 
Uy_ln_initV =  bbeta *( log(  (1-Tax)* e_mV * oy_ln_initV/y_piV * l_lntyV + kkV*(1+rsV) - kkVV ) - l_lntyV^(1+eeta) /(1+eeta)  )

Um_hf_initV = bbeta *(  log(  (1-Tax)* e_mV * om_hf_initV/y_piV * l_hftmV + kkV*(1+rsV) - kkVV ) - l_hftmV^(1+eeta) /(1+eeta)  )
Um_hn_initV = bbeta *(  log(  (1-Tax)* e_mV * om_hn_initV/y_piV * l_hntmV + kkV*(1+rsV) - kkVV ) - l_hntmV^(1+eeta) /(1+eeta)  )
Um_lf_initV = bbeta *(  log(  (1-Tax)* e_mV * om_lf_initV/y_piV * l_lftmV + kkV*(1+rsV) - kkVV ) - l_lftmV^(1+eeta) /(1+eeta) )
Um_ln_initV =  bbeta *(  log(  (1-Tax)* e_mV * om_ln_initV/y_piV * l_lntmV + kkV*(1+rsV) - kkVV ) - l_lntmV^(1+eeta) /(1+eeta)  ) 


Uy_hf_initVV =  bbeta *( log(  (1-Tax)* e_mV * oy_hf_initV/y_piV * l_hftyV +  kkV*(1+rsV) - kkVV ) - l_hftyV^(1+eeta) /(1+eeta)  );
Uy_hn_initVV = bbeta *(  log(  (1-Tax)* e_mV * oy_hn_initV/y_piV * l_hntyV + kkV*(1+rsV) - kkVV ) - l_hntyV^(1+eeta) /(1+eeta)  );
Uy_lf_initVV = bbeta *(  log(  (1-Tax)* e_mV * oy_lf_initV/y_piV * l_lftyV +  kkV*(1+rsV) - kkVV ) - l_lftyV^(1+eeta) /(1+eeta)  ); 
Uy_ln_initVV = bbeta *(  log(  (1-Tax)* e_mV * oy_ln_initV/y_piV * l_lntyV + kkV*(1+rsV) - kkVV ) - l_lntyV^(1+eeta) /(1+eeta)  );

Um_hf_initVV =  bbeta *( log(  (1-Tax)* e_mV * om_hf_initV/y_piV * l_hftmV + kkV*(1+rsV) - kkVV ) - l_hftmV^(1+eeta) /(1+eeta)  );
Um_hn_initVV =  bbeta *(  log(  (1-Tax)* e_mV * om_hn_initV/y_piV * l_hntmV + kkV*(1+rsV) - kkVV ) - l_hntmV^(1+eeta) /(1+eeta)  );
Um_lf_initVV =  bbeta *( log(  (1-Tax)* e_mV * om_lf_initV/y_piV * l_lftmV + kkV*(1+rsV) - kkVV ) - l_lftmV^(1+eeta) /(1+eeta) ); 
Um_ln_initVV = bbeta *(  log(  (1-Tax)* e_mV * om_ln_initV/y_piV * l_lntmV + kkV*(1+rsV) - kkVV ) - l_lntmV^(1+eeta) /(1+eeta) ); 
