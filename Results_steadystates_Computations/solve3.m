function WW = solve3(x, ddelta_K, kappa, Tax,eeta, bbeta,aalpha ,ssigmaTFP,rrhoTFP ,zz ,inzz,ddeltaCov, ssp, ssigmaparam, xiparam, varrho, upsilon,varepsilon,zetaparam, rs, zma, zya, e_m, alp, de, theta_hf,theta_hn,theta_lf,theta_ln,phi_hf,phi_hn,phi_lf,phi_ln,N_forcef,lambdacf,alpha_cob)
WW = [
% variables;
% x(1) = lambdac
% x(2)  = cm 
...
x(3) -  bbeta/x(1);
x(4) -  bbeta/x(1);
-x(5) + ((x(1)  *(1-Tax)*e_m * x(8))/(bbeta*x(34)) )^(1/eeta); 
-x(6) + ((x(1)  *(1-Tax)*e_m * x(9))/(bbeta*x(34)) )^(1/eeta) ;
 - x(24) + (( x(1) * (1-Tax)* e_m * x(14) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(25) + (( x(1) * (1-Tax)* e_m * x(15) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(26) + (( x(1) * (1-Tax)* e_m * x(16) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(27) + (( x(1) * (1-Tax)* e_m * x(17) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(20)  + (( x(1) * (1-Tax)* e_m  * x(10) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - x(21)  + (( x(1) * (1-Tax)* e_m * x(11) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - x(22)  + (( x(1) * (1-Tax)* e_m * x(12) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - x(23)  + (( x(1) * (1-Tax)* e_m * x(13) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - aalpha + x(6)/(x(6)+x(5));
 x(18) - N_forcef; 
- x(34) +   (kappa/(1-bbeta)) * x(19);
-x(18) + (1-de)* x(18)  + x(32) * x(31) ;
-e_m + (x(6)+x(5))/x(18) ;              %-x(29) + x(18) *x(28); %-x(30) + x(18)^(1/(1-alp));
-x(29)/x(28) + x(30)^(1-alp);   % ms / Sfe  = tihhtness^(1-alp)
- x(30) +  1.75 ;
...
-x(5) + (((bbeta/x(5))  * (1-Tax) *e_m * x(8))/(bbeta*x(34) ) )^(1/eeta); 
-x(6) + (((bbeta/x(3)) * (1-Tax)  *e_m * x(9))/(bbeta*x(34) ) )^(1/eeta) ;
 - x(24) + (( (bbeta/x(35)) * (1-Tax) * e_m * x(14) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(25) + (( (bbeta/x(36)) * (1-Tax) * e_m * x(15) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(26) + (( (bbeta/x(37)) * (1-Tax) * e_m * x(16) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(27) + (( (bbeta/x(38)) * (1-Tax) * e_m * x(17) )/(bbeta* x(34) ) )^(1/eeta); 
 - x(20)  + (( (bbeta/x(39)) * (1-Tax) * e_m  * x(10) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - x(21)  + (( (bbeta/x(40)) * (1-Tax) * e_m * x(11) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - x(22)  + (( (bbeta/x(41)) * (1-Tax) * e_m * x(12) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
 - x(23)  + (( (bbeta/x(42)) * (1-Tax) * e_m * x(13) )/(bbeta* x(34) ) )^(1/eeta) ;  %  
];    